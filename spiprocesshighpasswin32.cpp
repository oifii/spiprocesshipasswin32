///////////////////////////////////////////////////////////////
// spiprocesshighpasswin32.cpp : Defines the entry point for the application.
//
// highpass filter
//
...
///////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "spiprocesshighpasswin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spiprocesshighpasswin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spiprocesshighpasswin32class"};				// the main window class name
...
Dsp::Filter* global_pDspFilter = new Dsp::SmoothedFilterDesign
    <Dsp::RBJ::Design::HighPass, 2> (1024);
...
static int highpassCallback( const void *inputBuffer, void *outputBuffer,
                         unsigned long framesPerBuffer,
                         const PaStreamCallbackTimeInfo* timeInfo,
                         PaStreamCallbackFlags statusFlags,
                         void *userData );
